...
function makeComment(tag){                                                   // hren tag
	...
	*/
	...
	var profileId = tag.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.innerHTML;
	var d = new Date();
	...
	*/
	...
	var newComment = "<tr><td><img src=\"https://socialqueen3.s3.amazonaws.com/username-" + profileId + "\" class=\"w3-circle\" height=\"50\" width=\"50\"></td><td><div class=\"comment-text\">" + textComment + "<br></div><div class=\"comment-info\"><pre><a href=\"profile?username=" + usernameComment + "\">" + usernameComment + "</a> " + timelineComment + "</pre></div></td></tr>";
	...
	req2.open("GET", "/save_comment?usernamePost=" + usernamePost + "&timelinePost=" + timelinePost + "&usernameComment=" + usernameComment + "&timelineComment=" + timelineComment + "&textComment=" + textComment + "&commentPhoto=" + profileId, true);
	req2.send();	
} // checked
